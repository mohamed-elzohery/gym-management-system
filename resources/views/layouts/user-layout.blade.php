        ...
        <ul class="navbar-nav ml-auto">
            <li class="dropdown user user-menu" style="cursor:pointer;">
                <div class="media align-items-center">
                    <img src="{{asset(auth()->user()->profileImageFile)}}" alt="User Avatar" class="mr-2 mt-1 img-size-32 img-circle mr-2">
                ...
                <ul class="dropdown-menu" style="width:200px">
                    <li class="user-header mb-1" style="height: 140px;">
                        <img class="profile-user-img img-fluid img-circle" src="{{asset(auth()->user()->profileImageFile)}}" alt="User profile picture">
                        <p class="mb-0">
                            {{ auth()->user()->name }}
                        </p>
                    </li>
...
>>>>>>> d13928f1d1e317728d93e6738f08d38ebb9e88d7
