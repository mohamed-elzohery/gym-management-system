                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input required minlength="4" maxlength="100" type="text" id="name" name="name" class=" form-control @error('name') is-invalid @enderror" value="{{ $cityData->name }}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <select required class=" form-control @error('manager_id') is-invalid @enderror" name="manager_id" id="manager_id">
