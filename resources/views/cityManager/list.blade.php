                    ...
                    <tbody>
                        ...
                        <tr id="did{{ $user->id }}">
                            ...
                            <td class="project-actions text-right">
                                ...
                                <a href="javascript:void(0)" onclick="deletecityManager({{ $user->id }})" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>

                                <a href="javascript:void(0)" onclick="banUser({{ $user->id }})" class="btn btn-dark btn-sm"><i class="fa fa-user-lock"></i></a>
